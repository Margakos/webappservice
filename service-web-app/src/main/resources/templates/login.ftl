...
<div class="container">
    <h1 class="welcome text-center">Regeneration</h1>
    <div class="card card-container">
        <h2 class='login_title text-center'>Login</h2>
        <hr>

        <form class="form-signin" action="/" method="post" id="loginForm" name="loginForm">
            <span id="reauth-email" class="reauth-email"></span>
            <p class="input_title">Email</p>
            <input name="username" type="text" id="inputEmail" class="login_box" placeholder="user@domain.com" required autofocus>
